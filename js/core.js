const GenerateContent = class {
  ...
  getYear = () => {
    let year = new Date();
    document.body.querySelector(".date").innerHTML += year.getFullYear();
  };
  getProductFormat = () => {
    let product = `
    <div
  ...
  setPageContent = (fruits) => {
    let card = "";
    let productContainer = document.body.querySelector("#products-list");
    for (const productNumber in fruits) {
